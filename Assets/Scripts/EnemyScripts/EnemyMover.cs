...
[RequireComponent(typeof(EnemyStander))]
public class EnemyMover : MonoBehaviour
{
    ...
    private IEnumerator MoveRight(float rightmostX)
    {
        ...
        float rightEdge = Mathf.Floor(rightmostX - _collider.bounds.extents.x);
    ...
    private IEnumerator MoveLeft(float leftmostX)
    {
        ...
        float leftEdge = Mathf.Ceil(leftmostX + _collider.bounds.extents.x);
